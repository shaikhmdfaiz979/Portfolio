...
function le(e, t, n, r) {
  let i = we((typeof t == `string` ? ae(t) : t).pathname || `/`, n);
...
function D(e, t = [], n = [], r = ``, i = !1) {
  let a = (e, a, o = i, s) => {
    ...
    (e.children &&
      ...
      !(e.path == null && !e.index) &&
        t.push({ path: l, score: ve(l, e.index), routesMeta: u }));
  };
  return (
    e.forEach((e, t) => {
...
function ve(e, t) {
  ...
  return (
    ...
    n
      .filter((e) => !_e(e))
      .reduce((e, t) => e + (fe.test(t) ? pe : t === `` ? O : he), r)
  );
}
function ye(e, t) {
...
function je(e, t, n, r = !1) {
  ...
  typeof e == `string`
    ...
    : ((i = { ...e }),
      ...
      w(!i.search || !i.search.includes(`#`), Oe(`#`, `search`, `hash`, i)));
  let a = e === `` || i.pathname === ``,
    o = a ? `/` : i.pathname,
    s;
  if (o == null) s = n;
...
var Ue = x.createContext(!1),
  We = x.createContext({ isTransitioning: !1 });
We.displayName = `ViewTransition`;
var Ge = x.createContext(new Map());
Ge.displayName = `Fetchers`;
var Ke = x.createContext(null);
Ke.displayName = `Await`;
var k = x.createContext(null);
k.displayName = `Navigation`;
var qe = x.createContext(null);
qe.displayName = `Location`;
var Je = x.createContext({ outlet: null, matches: [], isDataRoute: !1 });
Je.displayName = `Route`;
var Ye = x.createContext(null);
Ye.displayName = `RouteError`;
var Xe = `REACT_ROUTER_ERROR`,
  Ze = `REDIRECT`,
  Qe = `ROUTE_ERROR_RESPONSE`;
function $e(e) {
  if (e.startsWith(`${Xe}:${Ze}:{`))
    try {
...
function tt(e, { relative: t } = {}) {
  w(nt(), `useHref() may be used only in the context of a <Router> component.`);
  let { basename: n, navigator: r } = x.useContext(k),
    { hash: i, pathname: a, search: o } = ct(e, { relative: t }),
    s = a;
  return (
    n !== `/` && (s = a === `/` ? n : Me([n, a])),
...
function at(e) {
  x.useContext(k).static || x.useLayoutEffect(e);
}
function ot() {
  let { isDataRoute: e } = x.useContext(Je);
  return e ? Dt() : st();
}
function st() {
  w(
  ...
  let e = x.useContext(Ve),
    { basename: t, navigator: n } = x.useContext(k),
    { matches: r } = x.useContext(Je),
    { pathname: i } = rt(),
  ...
  return (
    ...
    x.useCallback(
      (r, s = {}) => {
        if ((T(o.current, it), !o.current)) return;
        if (typeof r == `number`) {
          n.go(r);
          return;
        }
...
function ct(e, { relative: t } = {}) {
  let { matches: n } = x.useContext(Je),
    { pathname: r } = rt(),
    i = JSON.stringify(Ae(n));
  return x.useMemo(() => je(e, JSON.parse(i), r, t === `path`), [e, i, r, t]);
}
function lt(e, t) {
  return ut(e, t);
}
function ut(e, t, n) {
  ...
  let { navigator: r } = x.useContext(k),
    { matches: i } = x.useContext(Je),
    a = i[i.length - 1],
    o = a ? a.params : {},
    s = a ? a.pathname : `/`,
    c = a ? a.pathnameBase : `/`,
...
var ft = x.createElement(dt, null),
  pt = class extends x.Component {
    constructor(e) {
      (super(e),
        (this.state = {
          location: e.location,
      ...
      let t =
        e === void 0
          ...
          : x.createElement(
              ...
              x.createElement(Ye.Provider, {
                value: e,
                children: this.props.component,
              }),
            );
      return this.context ? x.createElement(ht, { error: e }, t) : t;
    }
  };
pt.contextType = Ue;
var mt = new WeakMap();
function ht({ children: e, error: t }) {
  let { basename: n } = x.useContext(k);
  if (
    typeof t == `object` &&
    t &&
    `digest` in t &&
...
function gt({ routeContext: e, match: t, children: n }) {
  ...
  return (
    ...
    x.createElement(Je.Provider, { value: e }, n)
  );
}
function _t(e, t = [], n) {
  let r = n?.state;
...
function yt(e) {
  let t = x.useContext(Ve);
  return (w(t, vt(e)), t);
}
function bt(e) {
  let t = x.useContext(He);
  return (w(t, vt(e)), t);
}
function xt(e) {
...
function wt() {
  return bt(`useNavigation`).navigation;
}
function Tt() {
  let { matches: e, loaderData: t } = bt(`useMatches`);
  return x.useMemo(() => e.map((e) => E(e, t)), [e, t]);
}
function Et() {
  let e = x.useContext(Ye),
    t = bt(`useRouteError`),
    n = St(`useRouteError`);
...
(x.useOptimistic, x.memo(kt));
function kt({ routes: e, future: t, state: n, isStatic: r, onError: i }) {
  return ut(e, void 0, { state: n, isStatic: r, onError: i, future: t });
}
function At(e) {
  w(
    !1,
...
var un = x.createContext(void 0);
un.displayName = `FrameworkContext`;
function dn() {
  let e = x.useContext(un);
  return (
...
function mn({ page: e, ...t }) {
  let { router: n } = cn(),
    r = x.useMemo(() => ce(n.routes, e, n.basename), [n.routes, e, n.basename]);
  return r ? x.createElement(gn, { page: e, matches: r, ...t }) : null;
}
function hn(e) {
...
function gn({ page: e, matches: t, ...n }) {
  let r = rt(),
    ...
    u = x.useMemo(() => nn(e, t, l, a, r, `data`), [e, t, l, a, r]),
    d = x.useMemo(() => nn(e, t, l, a, r, `assets`), [e, t, l, a, r]),
    f = x.useMemo(() => {
...
var vn =
  ...
  window.document.createElement !== void 0;
try {
  vn && (window.__reactRouterVersion = `7.13.1`);
} catch {}
function yn({
  basename: e,
  children: t,
...
bn.displayName = `unstable_HistoryRouter`;
var xn = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Sn = x.forwardRef(function (
    {
      onClick: e,
      discover: t = `render`,
      prefetch: n = `none`,
    ...
    let {
      ...
      v = typeof l == `string` && xn.test(l),
      y = Be(l, h);
    l = y.to;
    let b = tt(l, { relative: r }),
      ee = rt(),
      S = null;
    if (o) {
      let e = je(o, [], ee.unstable_mask ? ee.unstable_mask.pathname : `/`, !0);
    ...
    let re = !(y.isExternal || i),
      ie = x.createElement(`a`, {
        ...p,
        ...T,
        href: (re ? S : void 0) || y.absoluteURL || b,
        onClick: re ? ne : e,
        ref: _n(m, w),
        target: c,
    ...
    return C && !v
      ? x.createElement(x.Fragment, null, ie, x.createElement(mn, { page: b }))
      : ie;
  });
Sn.displayName = `Link`;
var Cn = x.forwardRef(function (
  {
    "aria-current": e = `page`,
    caseSensitive: t = !1,
    className: n = ``,
  ...
  let u = ct(a, { relative: c.relative }),
    d = rt(),
    f = x.useContext(He),
    { navigator: p, basename: m } = x.useContext(k),
    h = f != null && zn(u) && o === !0,
...
var wn = x.forwardRef(
  (
    ...
    let { unstable_useTransitions: h } = x.useContext(k),
      g = Mn(),
      _ = Nn(s, { relative: l }),
      v = o.toLowerCase() === `get` ? `get` : `post`,
      y = typeof s == `string` && xn.test(s);
...
wn.displayName = `Form`;
function Tn({ getKey: e, storageKey: t, ...n }) {
  let r = x.useContext(un),
    { basename: i } = x.useContext(k),
    a = rt(),
    o = Tt();
  ...
  return x.createElement(`script`, {
    ...
    dangerouslySetInnerHTML: {
      __html: `(${c})(${Yt(JSON.stringify(t || Pn))}, ${Yt(JSON.stringify(s))})`,
    },
  });
}
Tn.displayName = `ScrollRestoration`;
function En(e) {
  return `${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`;
}
function Dn(e) {
...
var An = 0,
  jn = () => `__${String(++An)}__`;
function Mn() {
  let { router: e } = Dn(`useSubmit`),
    { basename: t } = x.useContext(k),
    n = Ct(),
    r = e.fetch,
    i = e.navigate;
  return x.useCallback(
...
var Pn = `react-router-scroll-positions`,
  Fn = {};
function In(e, t, n, r) {
  let i = null;
  return (
    r &&
      (i = r(
        n === `/` ? e : { ...e, pathname: we(e.pathname, n) || e.pathname },
        t,
      )),
    (i ??= e.key),
    i
...
function Ln({ getKey: e, storageKey: t } = {}) {
  let { router: n } = Dn(`useScrollRestoration`),
    { restoreScrollPosition: r, preventScrollReset: i } =
      On(`useScrollRestoration`),
    { basename: a } = x.useContext(k),
    o = rt(),
    s = Tt(),
    c = wt();
  (x.useEffect(
    ...
    Rn(
      x.useCallback(() => {
        ...
        try {
          sessionStorage.setItem(t || Pn, JSON.stringify(Fn));
        } catch (e) {
          T(
            !1,
    ...
    typeof document < `u` &&
      (x.useLayoutEffect(() => {
        try {
          let e = sessionStorage.getItem(t || Pn);
          e && (Fn = JSON.parse(e));
        } catch {}
      }, [t]),
      x.useLayoutEffect(() => {
...
function zn(e, { relative: t } = {}) {
  let n = x.useContext(We);
  w(
    n != null,
    "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?",
  );
  let { basename: r } = Dn(`useViewTransitionState`),
    i = ct(e, { relative: t });
  if (!n.isTransitioning) return !1;
  let a = we(n.currentLocation.pathname, r) || n.currentLocation.pathname,
    o = we(n.nextLocation.pathname, r) || n.nextLocation.pathname;
    ...
    (0, j.jsx)(`button`, {
      ...
      children: e
        ? (0, j.jsxs)(`svg`, {
            ...
            viewBox: `0 0 24 24`,
            children: [
              (0, j.jsx)(`circle`, { cx: `12`, cy: `12`, r: `5` }),
              (0, j.jsx)(`path`, {
...
function Wn() {
  return (0, j.jsx)(`nav`, {
    ...
    children: (0, j.jsxs)(`div`, {
      className: `max-w-7xl mx-auto flex justify-between items-center glass px-6 py-3 rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md`,
      children: [
        (0, j.jsx)(Sn, {
          to: `/`,
        ...
        (0, j.jsxs)(`div`, {
          children: [
            (0, j.jsxs)(`div`, {
              ...
              children: [
                (0, j.jsx)(`span`, {
                  className: `text-[10px] font-black uppercase tracking-[0.2em] text-indigo-600 dark:text-indigo-400`,
                  children: e.category,
                }),
                (0, j.jsx)(`div`, {
            ...
            (0, j.jsx)(`h3`, {
              className: `text-3xl font-bold mt-3 text-slate-900 dark:text-white leading-tight`,
              children: e.title,
            }),
            (0, j.jsx)(`p`, {
              className: `mt-4 text-slate-600 dark:text-slate-400 text-sm leading-relaxed max-w-sm`,
        ...
        (0, j.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, j.jsxs)(`a`, {
              ...
              children: [
                `Live Demo `,
                (0, j.jsx)(`span`, { className: `ml-2`, children: `→` }),
              ],
            }),
          ],
        }),
...
var Kn = [
  {
    ...
    description: `Built a high-performance shopping experience featuring dynamic cart logic, Stripe integration, and optimized image loading.`,
    tech: [`React`, `Tailwind`, `Redux`, `Toastify`],
    link: `https://e-commerce.shaikhmdfaiz979.workers.dev/`,
    github: `https://github.com/shaikhmdfaiz979/E-Commerce`,
    size: `md:col-span-2`,
  },
  {
    id: 2,
    ...
    description: `A comprehensive data visualization tool with real-time charts, user permission management, and dark mode support.`,
    tech: [`React`, `Recharts`, `Axios`, `Vite`],
    link: `https://admin-dashboard-cnu.pages.dev/`,
    ...
    children: [
      (0, j.jsxs)(`section`, {
        ...
        children: [
          ...
          (0, j.jsx)(`p`, {
            className: `mt-8 text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed`,
            children: `Specializing in building clean, responsive, and user-centric web applications. Expertise in React, modern state management, and pixel-perfect CSS.`,
          }),
          (0, j.jsx)(`div`, {
      ...
      (0, j.jsx)(`section`, {
        ...
        children: Kn.map((e) => (0, j.jsx)(Gn, { project: e }, e.id)),
      }),
    ],
  });
}
function Jn() {
  return (0, j.jsx)(`div`, {
    className: `min-h-screen not-dark:bg-slate-300 dark:bg-[#020617] transition-colors duration-500`,
    children: (0, j.jsxs)(`div`, {
        ...
        (0, j.jsxs)(`header`, {
          ...
          children: [
            ...
            (0, j.jsx)(`p`, {
              ...
              children: `A collection of frontend projects focusing on complex state management and responsive UI.`,
            }),
          ],
        }),
        (0, j.jsx)(`div`, {
        ...
        children: [
          (0, j.jsxs)(`button`, {
            ...
            children: [
              n,
              (0, j.jsx)(`span`, {
                className: `absolute bottom-0 left-0 w-0 h-1 bg-indigo-600 transition-all group-hover:w-full`,
              }),
            ],
          }),
          (0, j.jsx)(`p`, {
            className: `mt-4 text-sm font-medium transition-all duration-300 ${e ? `text-green-500 scale-110` : `text-slate-400 opacity-0 group-hover:opacity-100`}`,
            children: e
...
function Xn() {
  return (0, j.jsx)(`footer`, {
    className: `mt-5 pb-20 px-6 border-t border-slate-200 dark:border-slate-800`,
    children: (0, j.jsxs)(`div`, {
      className: `max-w-7xl mx-auto pt-24 text-center`,
      children: [
        (0, j.jsxs)(`h2`, {
          className: `text-4xl md:text-6xl font-black tracking-tighter text-slate-900 dark:text-white mb-12`,
          children: [
            `Ready to start a `,
            (0, j.jsx)(`br`, {}),
            (0, j.jsx)(`span`, {
        ...
        (0, j.jsx)(Yn, {}),
        (0, j.jsxs)(`div`, {
          className: `mt-20 flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-slate-500 font-medium`,
          children: [
            (0, j.jsx)(`p`, {
              children: `© 2026 Md Faiz. Built with React & Vite.`,
            }),
            (0, j.jsxs)(`div`, {
  ...
  return (0, j.jsx)(yn, {
    children: (0, j.jsxs)(`div`, {
      ...
      children: [
        ...
        (0, j.jsx)(Zn, {}),
        (0, j.jsx)(`main`, {
          children: (0, j.jsxs)(Mt, {
            children: [
              (0, j.jsx)(At, { path: `/`, element: (0, j.jsx)(qn, {}) }),
              (0, j.jsx)(At, { path: `/work`, element: (0, j.jsx)(Jn, {}) }),
            ],
          }),
        }),
        (0, j.jsx)(Xn, {}),
...
Hn.createRoot(document.getElementById(`root`)).render(
  (0, j.jsx)(x.StrictMode, { children: (0, j.jsx)(Qn, {}) }),
);
